...
const menuItems = [
  ...
  { id: 'strawberry_shortcake',    name: 'Strawberry Shortcake',    price: 6.50, description: 'Airy sponge layered with cream and berries',      image: StrawberryShortcake,    imageUrl: `${BASE}/StrawberryShortcake.png` },
  { id: 'raspberry_cheesecake_pot',name: 'Raspberry Cheesecake Pot',price: 5.50, description: 'Tangy raspberry on smooth cheesecake cream',      image: RaspberryCheesecakePot, imageUrl: `${BASE}/RaspberryCheesecakePot.png` },
  ...
  { id: 'glazed_cinnamon_roll',    name: 'Glazed Cinnamon Roll',    price: 5.00, description: 'Pillowy swirl with warm cinnamon and glaze',      image: GlazedCinnamonRoll,     imageUrl: `${BASE}/GlazedCinnamonroll.png` },
  { id: 'chocolate_swiss_roll',    name: 'Chocolate Swiss Roll',    price: 5.50, description: 'Cocoa sponge rolled with chocolate cream',        image: ChocolateSwissRoll,     imageUrl: `${BASE}/ChocolateSwissRoll.png` },
  { id: 'berry_pancakes',          name: 'Berry Pancakes',          price: 6.50, description: 'Fluffy stacks loaded with fresh berries',         image: PancakesBerry,          imageUrl: `${BASE}/Pancakes_Berry.png` },
  { id: 'creme_caramel',           name: 'Crème Caramel',           price: 5.00, description: 'Silky custard with a golden caramel top',         image: CremeCaramel,           imageUrl: `${BASE}/CremeCaramel.png` },
  // ── Page 2+ ──────────────────────────────────────────────────
  { id: 'bakewell_tart',           name: 'Bakewell Tart',           price: 5.00, description: 'Almond frangipane on buttery shortcrust',         image: BakewellTart,           imageUrl: `${BASE}/BakewellTart.png` },
  ...
  { id: 'banoffee_pot',            name: 'Banoffee Pot',            price: 5.50, description: 'Toffee, banana and whipped cream in a jar',       image: BanoffeePot,            imageUrl: `${BASE}/BanoffeePot.png` },
  ...
  { id: 'chocolate_donut',         name: 'Chocolate Donut',         price: 4.00, description: 'Fluffy ring glazed in dark chocolate',            image: ChocolateDonut,         imageUrl: `${BASE}/ChocolateDonut.png` },
  { id: 'cookie_n_cream_pot',      name: 'Cookie N Cream Pot',      price: 5.50, description: 'Crushed cookies folded into vanilla cream',       image: CookieNCreamPot,        imageUrl: `${BASE}/CookieNCreamPot.png` },
  ...
  { id: 'lemon_blueberry_pot',     name: 'Lemon Blueberry Pot',     price: 5.50, description: 'Tangy lemon cream with fresh blueberries',        image: LemonBlueberryPot,      imageUrl: `${BASE}/LemonBlueberryPot.png` },
  { id: 'lemon_donut',             name: 'Lemon Donut',             price: 4.00, description: 'Soft ring glazed with bright lemon icing',        image: LemonDonut,             imageUrl: `${BASE}/LemonDonut.png` },
  { id: 'chocolate_pancakes',      name: 'Chocolate Pancakes',      price: 6.50, description: 'Thick chocolate stacks with cocoa drizzle',       image: PancakesChocolate,      imageUrl: `${BASE}/Pancakes_Chocolate.png` },
  { id: 'rainbow_pancakes',        name: 'Rainbow Pancakes',        price: 6.50, description: 'Colourful layered stacks with whipped cream',     image: PancakesRainbow,        imageUrl: `${BASE}/Pancakes_Rainbow.png` },
  ...
  { id: 'strawberry_donut',        name: 'Strawberry Donut',        price: 4.00, description: 'Pillowy ring glazed in strawberry pink',          image: StrawberryDonut,        imageUrl: `${BASE}/StrawberryDonut.png` },
  ...
  { id: 'swiss_roll',              name: 'Swiss Roll',              price: 5.00, description: 'Fluffy vanilla sponge rolled with fresh cream',    image: SwissRoll,              imageUrl: `${BASE}/SwissRoll.png` },
