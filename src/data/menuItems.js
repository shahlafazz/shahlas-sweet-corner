...
const menuItems = [
  ...
  { id: 'glazed_cinnamon_roll',    name: 'Glazed Cinnamon Roll',    mobileName: 'Cinnamon Roll',    price: 5.00, description: 'Pillowy swirl with warm cinnamon and glaze',      image: GlazedCinnamonRoll,     imageUrl: `${BASE}/GlazedCinnamonroll.png` },
  { id: 'chocolate_swiss_roll',    name: 'Chocolate Swiss Roll',    mobileName: 'Cocoa Swiss Roll', price: 5.50, description: 'Cocoa sponge rolled with chocolate cream',        image: ChocolateSwissRoll,     imageUrl: `${BASE}/ChocolateSwissRoll.png` },
