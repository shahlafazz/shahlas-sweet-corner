...
/* Oven timer ding — single clean bell, long natural ring-out */
export function playOvenDing() {
  try {
    ...
    [1047, 2094].forEach((freq, i) => {
      ...
      osc.frequency.exponentialRampToValueAtTime(freq * 0.97, now + 2.0);
      const vol = i === 0 ? 0.30 : 0.08;
